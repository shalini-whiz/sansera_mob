...
let created_process_schema = [
  ...
  },
  {
    ...
    displayName: 'OK Billets Weight (kg)',
    placeholder: '',
    value: '',
    error: '',
    required: true,
